...
export type DrtsQuery = { __typename?: 'Query' } & {
  drtTrialResponses: Array<
    { __typename?: 'DrtTrialResponse' } & Pick<
      DrtTrialResponse,
      | 'id'
      | 'participant_id'
      | 'question'
...
export type UpdateUserRoleMutation = { __typename?: 'Mutation' } & {
  updateUser?: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'role'>>
}
...
export const DrtsDocument = `
  ...
  drtTrialResponses(orderBy: {id: asc}, take: $limit, cursor: $cursor) {
    ...
    `
export const useDrtsQuery = <TData = DrtsQuery, TError = unknown>(
  client: GraphQLClient,
...
>(
  ...
  useQuery<FindUserByIdQuery, TError, TData>(
    ...
    fetcher<FindUserByIdQuery, FindUserByIdQueryVariables>(
      client,
