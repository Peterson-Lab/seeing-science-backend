...
const options = {
	...
	readQueue: 'lexical_quiz_dbread',
	writeQueue: 'lexical_quiz_dbwrite',
	taskQueue: 'lexical_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'lexical', false);
		worker.start();
	})
	.catch(err => {
