...
const options = {
	...
	readQueue: 'mentalfolding_quiz_dbread',
	writeQueue: 'mentalfolding_quiz_dbwrite',
	taskQueue: 'mentalfolding_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'mentalfolding', false);
		worker.start();
	})
	.catch(err => {
